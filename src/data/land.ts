        ...
        review: [
          {
            ...
            text: 'В новой компании я получил позицию Senior PHP Developer. Процесс поиска и выбора вакансий через Buxonline оцениваю хорошо. Это была первая предложенная вакансия скаутом, на нее я и прошёл. С
                      {
                        id: 0,
                        photo: photo1,
                        name: 'Ростислав Прозоровский',
                        position: 'Senior PHP Developer',
                        text: 'В новой компании я полу��ил позицию Senior PHP Developer. Процесс поиска и выбора вакансий через Buxonline оцениваю хорошо. Это была первая предложенная вакансия скаутом, на нее я и прошёл. Считаю, что Марина хорошо понимает потребности и умеет подобрать вакансии, соответствующие навыкам и ожиданиям специалистов. Качество поддержки, которое я получал от скаута в процессе поиска, оцениваю хорошо. Каких-либо сложностей или непонятностей при сотрудничестве с сервисом Buxonline не было. Единственное было не ясно, как происходит оплата, но этот момент решился и договорились со скаутом о процессе оплаты. Уверен, что этот сервис помог мне повысить шансы успешного трудоустройства за рубежом. Сервис Buxonline уже порекомендовал своим знакомым IT-специалистам, которые ищут работу по прямым контрактам.'
                      },
                      {
                        id: 1,
                        photo: photo2,
                  ...
                  steps: {
                    ...
                    step: [
                      ...
                      },
                      {
                        ...
                        text: 'Мы высылаем вам договор. В нем указаны условия трудоустройства. Ознакомьтесь, заданием
                                  {
                                    title: 'Юридическое оформление',
