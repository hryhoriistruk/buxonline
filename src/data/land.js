...
const land = [
  {
    ru: {
      ...
      footer: {
        address: ['65000, Украина, Одесса','ул. Старопортофранковская','Лицензия номер: 2634748'],
        bot: ['Подключиться к телеграм-боту','https://t.me/buxonline'],
        privacy: ['Политика конфиденциальности', '/policy'],
      ...
      err: {
        ...
        subtitle: 'Ошибка 404',
        text: 'К сожалению, запрашиваемая страница не найдена. Пожалуйста, вернитесь на главную страницу.',
